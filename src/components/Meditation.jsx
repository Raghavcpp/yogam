  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto text-center">
        {/* Heading */}
        <h2 className="meditate-animate text-3xl sm:text-4xl font-serif font-extrabold text-black-700 mb-6">
        ...
        <a
          ...
          className="meditate-animate inline-block mt-6 text-black-600 hover:underline text-sm font-medium"
        >
      ...
      <div className="absolute top-10 left-[-50px] w-72 h-72 bg-black-200 rounded-full blur-3xl opacity-25 -z-10" />
