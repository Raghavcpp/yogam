  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto text-center">
        <h2
          ref={titleRef}
          className="text-3xl sm:text-4xl font-extrabold mb-6 text-black-700"
        >
        ...
        <h3
          ...
          className="text-2xl font-semibold mb-3 text-black-600"
        >
      ...
      <div className="absolute -top-10 -right-10 w-40 h-40 bg-black-100 rounded-full blur-2xl opacity-40" />
