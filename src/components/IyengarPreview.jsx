  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto">
        {/* Section Heading */}
        <h2 className="iyengar-animate text-3xl sm:text-4xl font-extrabold text-black-700 text-center mb-10">
        ...
        <div className="iyengar-animate">
          <h3 className="text-2xl font-semibold text-black-700 text-center mb-6">
          ...
          <div className="flex overflow-x-auto space-x-6 snap-x scrollbar-hide">
            {feedbacks.map((fb, idx) => (
              <div
                key={idx}
                className="snap-center min-w-[250px] bg-black-50 rounded-xl shadow p-4 flex flex-col justify-between"
              >
      ...
      {/* <div className="absolute top-20 right-[-50px] w-72 h-72 bg-black-200 rounded-full blur-3xl opacity-20 -z-10" /> */}
    </section>
  );
}
