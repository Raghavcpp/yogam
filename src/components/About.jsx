  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto text-center mb-12">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-black-700 mb-4">
      ...
      <div className="relative -left-6 mx-auto grid grid-cols-2 md:grid-cols-4 justify-items-center gap-4 text-center w-screen">
        <img
          effect="blur"
          src="900 x 1284/h2-img1.jpg"
          alt="h2-img1.png"
          data-aos="fade-right"
          className="rounded-tl-full max-h-100"
        />
        <img
          effect="blur"
          src="900 x 1284/h2-img2.jpg"
          alt="h2-img2.png"
          data-aos="fade-up"
          className="rounded-tr-full md:rounded-t-full max-h-100"
        />
        <img
          effect="blur"
          src="900 x 1284/h2-img3.jpg"
          alt="h2-img3.png"
          data-aos="fade-up"
          className="rounded-bl-full md:rounded-bl-none md:rounded-t-full max-h-100"
        />
        <img
          effect="blur"
          src="900 x 1284/h2-img4.jpg"
          alt="h2-img4.png"
          data-aos="fade-left"
          className="rounded-br-full md:rounded-br-none md:rounded-tr-full max-h-100"
        />
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto mt-20">
        ...
        <div className="about-card bg-white rounded-2xl shadow-lg p-6 text-left">
          <h3 className="text-xl font-bold text-black-600 mb-3">
      ...
      {/* <div className="absolute top-0 left-0 w-72 h-72 bg-black-200 rounded-full blur-3xl opacity-30 -z-10" />
